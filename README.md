...
I'm a Software Engineer focused on backend development — designing APIs, services, and data layers that are reliable, scalable, and built to last.

At **Estrel AI**, I work on backend infrastructure for an enterprise automation platform, handling everything from API design to database architecture to system performance. I enjoy the engineering fundamentals: clean architecture, solid data modeling, and building systems that hold up in production.

I'm also curious about applying AI to real products, and I've built projects combining backend engineering with LLM-powered features.
...
**AI / ML**
<p>
<img src="https://img.shields.io/badge/LangChain-493D9E?style=for-the-badge&logo=langchain&logoColor=white"/>
